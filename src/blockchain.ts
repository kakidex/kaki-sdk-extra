import { ChainId, Currency, ETHER, MATIC, BINANCE_COIN } from 'kaki-sdk'
  ...
  setBlockchain(blockchain?: Blockchain) {
    if (blockchain) {
      ...
      switch (this.chainId) {
        ...
        break
        case 137:
          this.blockchain = Blockchain.MATIC
        break
        default:
  ...
  setRpcURLs(rpcURLs?: string[]){
    if (rpcURLs && rpcURLs.length > 0) {
      ...
      switch (this.chainId) {
        ...
        case 137:
          this.rpcURLs = [
            'https://polygon-mainnet.g.alchemy.com/v2/kW-q3YoEOkX569sCP0vXqoPp65PzYai2'
          ]
          break
        default:
          this.rpcURLs = this.rpcAPIKey && this.rpcAPIKey !== '' ? [`https://mainnet.infura.io/v3/${this.rpcAPIKey}`] : ['https://mainnet.infura.io/v3/']
...
export const BLOCKCHAIN_SETTINGS: { [chainId in ChainId]: BlockchainSettings } = {
  ...
  [ChainId.MATIC_MAINNET]: new BlockchainSettings(ChainId.MATIC_MAINNET),
}
