import DEFAULT_TOKEN_LIST from 'kaki-default-token-list'
import COMMUNITY_TOKEN_LIST from 'testing-community-token-list'
import { ChainId, Token } from 'kaki-sdk'
...
export const TOKENS: { [chainId in ChainId]: Tokens } = {
  ...
  [ChainId.MATIC_MAINNET]: new Tokens(ChainId.MATIC_MAINNET),
}
